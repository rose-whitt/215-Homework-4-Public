...
class ConciseSetGeneratorTest {
    ...
    void testDoesNotMutateAllCases() {
        ...
        assertEquals(allCases, generateIntegerCases(10));
    }
    ...
    void testDoesNotMutateCaseToFiles() {
        ...
        TestResults input = new TestResults(allCases, caseToFiles, wrongSet);
        ConciseSetGenerator.setCover(input);
        System.out.println(caseToFiles);
        System.out.println(generateSimpleCaseToFile(10));
        assertEquals(caseToFiles, generateSimpleCaseToFile(10));
    }
    ...
    void testDoesNotMutateWrongSet() {
        ...
        TestResults input = new TestResults(allCases, caseToFiles, wrongSet);
        ConciseSetGenerator.setCover(input);
        assertEquals(wrongSet, generateAllWrong(10));
    }
     ...
     */
    private List<TestCase> generateIntegerCases(int numTests) {
        List<TestCase> allCases = new ArrayList<>();
     ...
     */
    private Set<Integer> generateAllWrong(int numFiles) {
     ...
     */
    private List<Set<Integer>> generateSimpleCaseToFile(int numTests) {
        List<Set<Integer>> caseToFiles = new ArrayList<>();
        for (int i = 0; i < numTests; i++) {
            Set<Integer> set = new HashSet<>();
            set.add(i);
     ...
     */
    private void testNeedAllHelper(List<TestCase> allCases) {
        // Every file is wrong
        Set<Integer> wrongSet = generateAllWrong(10);
     ...
     * @param allCases the test cases
     */
    private void testOverlapHelper(List<TestCase> allCases, Set<TestCase> expected) {
